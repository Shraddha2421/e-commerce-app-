        ...
        <>
            ...
            <section className='section__container bg-primary-light'>
                ...
                <div className='section__subheader space-x-2'>
                    <span className='hover:text-purple-700'><Link to="/">home</Link></span>
                    <i className="ri-arrow-right-s-line"></i>
                    <span className='hover:text-purple-700'><Link to="/shop">shop</Link></span>
                    <i className="ri-arrow-right-s-line"></i>
                    <span className='hover:text-purple-700'>{singleProduct.name}</span>
                </div>
            </section>
            ...
            <section className='section__container mt-8'>
                <div className='flex flex-col items-center md:flex-row gap-8'>
                    ...
                    <div className='md:w-1/2 w-full'>
                        ...
                        <p className='text-xl text-purple-700 mb-4 space-x-1'>
                            ${singleProduct?.price} 
                        ...
                        className='mt-6 px-6 py-3 bg-purple-700 text-white rounded-md'>
                            Add to Cart
                        </button>
                    </div>
                </div>
