...
const API_URL = getBaseUrl ? `${getBaseUrl}/api/cart/add` : "http://localhost:3000/api/cart";
                    ...
                    <div className="relative">
                        ...
                        <div className="hover:block absolute top-3 right-3">
                            <button onClick={(e) => {
                                ...
                                <i className="ri-shopping-cart-2-line bg-purple-700 text-white p-1.5 hover:bg-purple-900"></i>
                            </button>
                        </div>
                    </div>
