...
const API_URL = getBaseUrl ? `${getBaseUrl}/api/cart` : "http://localhost:3000/api/cart";
            ...
            <div className={`fixed right-0 top-0 md:w-1/3 w-full bg-white h-full overflow-y-auto transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
                ...
                <div className="p-4 mt-4">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="text-gray-900 hover:text-gray-300 transition-all duration-200 bg-purple-700 hover:bg-purple-700 rounded" onClick={onClose}>
                            ...
                            cart.items.map((item, index) => (
                                ...
                                >
                                    <div className="flex items-center">
                                        <span className="mr-4 px-2 bg-purple-700 text-white rounded-full">
                                            {index + 1}
                                        </span>
                                        <img
                                            src={item.image}
                                    ...
                                    <div className="flex items-center mt-2 md:mt-0 gap-2">
                                        <button
                                            ...
                                            className="size-6 flex items-center justify-center rounded-full bg-gray-200 text-gray-700 hover:bg-purple-700 hover:text-white transition-all duration-200"
                                        >-</button>
                                        <span className="bg-white text-purple-700 py-1 rounded-full">{item.quantity}</span>
                                        <button
