        ...
        <section className="h-screen flex items-center justify-center">
            <div className="max-w-sm border shadow bg-white mx-auto p-8">
                ...
                <form onSubmit={handleRegister} className="space-y-5 max-w-sm mx-auto pt-8">
                    ...
                    <button type="submit" className="w-full mt-5 bg-purple-700 text-white hover:bg-primary font-medium py-3 rounded-md">Register</button>
                </form>
                <p className="my-5 italic text-sm text-center">Already have an account? <Link to="/login" className="text-purple-700 underline px-1">Login </Link>here</p>
            </div>
        </section>
    );
};
